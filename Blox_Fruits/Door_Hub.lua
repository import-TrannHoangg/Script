     ...
     while wait() do
         if _G.SafeFarm then
              ...
              for i, v in pairs(game:GetService("Players").LocalPlayer.PlayerScripts:GetDescendants()) do
                  if v:IsA("LocalScript") then
                      if v.Name == "RobloxMotor6DBugFix" or v.Name == "Clans" or v.Name == "Codes" or v.Name == "CustomForceField" or v.Name == "MenuBloodSp" or v.Name == "PlayerList"
                      then
                           v:Destroy()
                      end
                  end
...
function EquipTool(toolName)
    ...
    if character and not character:FindFirstChild(toolName) and backpack then
...
function BTP(Tarpos)
    ...
    local distance = (Tarpos.Position - hrp.Position).Magnitude
    if distance > 2000 then
        ...
        if lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") then
            lp.Character.HumanoidRootPart.CFrame = Tarpos
        end
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
        task.wait(7)
    else
...
AddToggle("Farm", "Farm Cấp Độ", false, function(Value)
    ...
    while true do
        ...
        if LevelFarmQuest then
            pcall(function()
                ...
                local hasQuest = string.find(questGui.Container.QuestTitle.Title.Text, NameMon)

                if not hasQuest or questGui.Visible == false then
                ...
                elseif hasQuest or questGui.Visible == true then
                        ...
                        for _, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                if v.Name == Ms then
                                    ...
                                    until not LevelFarmQuest or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or questGui.Visible == false
                                end
                            end
                        end
                    else

...
function CheckLevel()
    ...
    if Second_Sea then
        ...
        elseif Lv == 1250 or Lv <= 1274 or SelectMonster == "Ship Deckhand" or SelectArea == 'Ship' then -- Ship Deckhand
            ...
            if _G.Configs.AutoFarmLevel and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
...
AddToggle("Farm", "Auto Farm Level", _G.Configs.AutoFarmLevel, function(value)

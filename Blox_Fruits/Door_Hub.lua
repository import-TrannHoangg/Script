...
ShutDownCorner.CornerRadius = UDim.new(1, 0)
...
function AddSection(tabName,text)
    ...
    local Line = Instance.new("Frame")
    Line.Size = UDim2.new(1,-220,0,1)
    Line.Position = UDim2.new(0,220,0.5,0)
    Line.BorderSizePixel = 0
    Line.Parent = Frame
...
GlowBackground.Size = UDim2.new(0,720,0,500)
MainFrame.BackgroundTransparency = 0.35
GlowBackground.BackgroundTransparency = 0.8
...
local ShutDownBtn = Instance.new("TextButton")
ShutDownBtn.Size = UDim2.new(0, 22, 0, 22)
ShutDownBtn.Position = UDim2.new(1, -35, 0, 14)
ShutDownBtn.BackgroundColor3 = Color3.fromRGB(150, 40, 40)
ShutDownBtn.Text = "X"
ShutDownBtn.Font = Enum.Font.GothamBold
...
CreateIconFrame(SliderFrame, iconStr, 10, 12)
